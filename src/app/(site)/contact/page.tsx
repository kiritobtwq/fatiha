          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div style={{ position: 'relative', overflow: 'hidden', height: 400 }}>
                <a href="https://yandex.ru/maps/org/mechet_fatikha_dum_rb/83210863911/?utm_medium=mapframe&utm_source=maps" style={{ color: '#eee', fontSize: 12, position: 'absolute', top: 0 }}>
                  Мечеть Фатиха Дум РБ
                </a>
                <a href="https://yandex.ru/maps/20689/birsk/category/religious_organization/184106296/?utm_medium=mapframe&utm_source=maps" style={{ color: '#eee', fontSize: 12, position: 'absolute', top: 14 }}>
                  Религиозное объединение в Бирске
                </a>
                <iframe
                  src="https://yandex.ru/map-widget/v1/?ll=55.527581%2C55.417894&mode=search&oid=83210863911&ol=biz&z=17.1"
                  width="100%"
                  height="400"
                  frameBorder="1"
                  allowFullScreen
